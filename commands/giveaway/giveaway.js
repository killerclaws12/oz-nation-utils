...
module.exports = {
	...
	run: async(client, message, args) => {
		if(!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send('You dont have permission to use this command.')
		...
		client.giveaways.start(channel, {
			...
			messages: {
				...
				inviteToParticipate: "React with 🎉 to enter in the giveaway!",
				winMessage: "Congrats {winner}, you have won the giveaway",
